...
<script type='text/javascript'>
 $(function() {
	...
	$( "#datepicker" ).datepicker('setDate','<? echo ( isset($info['datetime_start']) ? $info['datetime_start'] : set_value('datepicker')); ?>');
	$( "#from" ).datepicker();
	$( "#from" ).datepicker("option", "dateFormat", "d MM yy");
	$( "#from" ).datepicker('setDate','<? echo ( isset($info['datetime_start']) ? $info['datetime_start'] : set_value('from')); ?>');
	$( "#to" ).datepicker();
	$( "#to" ).datepicker("option", "dateFormat", "d MM yy");
	$( "#to" ).datepicker('setDate','<? echo ( isset($info['datetime_end']) ? $info['datetime_end'] : set_value('to')); ?>');
